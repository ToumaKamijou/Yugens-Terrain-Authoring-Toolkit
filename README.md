...
2. Wall textures don't disappear properly when the "void" texture is selected (will be fixed in 1.1)
...
7. Terrain sizes are very big causing warning messages (will be fixed in 1.1.X/)
